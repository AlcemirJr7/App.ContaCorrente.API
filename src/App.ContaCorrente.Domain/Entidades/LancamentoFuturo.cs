...
namespace App.ContaCorrente.Domain.Entidades
{
    public class LancamentoFuturo
    {
        ...
        public EnumLancamentosFuturos FlagLancamento { get; private set; }
        ...
        public void Atualizar(decimal valor, DateTime dataCadastro, DateTime dataParaLancamento, EnumLancamentosFuturos flagLancamento, DateTime? dataLancamento, int historicoId, int correntistaId)
        {
            ValidarEntidade(valor, dataCadastro, dataParaLancamento, flagLancamento, dataLancamento);
            HistoricoId = historicoId;
            CorrentistaId = correntistaId;
        ...
        private void ValidarEntidade(decimal valor, DateTime dataCadastro, DateTime dataParaLancamento, EnumLancamentosFuturos flagLancamento, DateTime? dataLancamento)
        {
            ...
            DomainExcepitonValidacao.When(Enum.IsDefined(typeof(EnumLancamentosFuturos),flagLancamento), "Flag lançamento invalido.");
